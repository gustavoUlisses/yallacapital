      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="divide-y divide-[#E2E8F0] border-t border-[#E2E8F0]">
          {preview.map((tx, i) => (
            <div
              key={i}
              className="group relative grid grid-cols-12 items-center gap-4 py-6 hover:bg-[#F8F9FC] -mx-6 px-6 transition-colors duration-200"
            >
              ...
              <div className="col-span-12 sm:col-span-5 flex items-center gap-3">
                <div className="bg-white border border-[#E2E8F0] rounded-sm px-3 py-2 flex items-center justify-center w-24 h-10 flex-shrink-0">
                ...
                <span className="text-[#C4A35A] flex-shrink-0">→</span>
                <div className="bg-white border border-[#E2E8F0] rounded-sm px-3 py-2 flex items-center justify-center w-24 h-10 flex-shrink-0">
                  <div className="relative w-full h-full">
                    <Image
                      src={tx.acquirerLogo}
