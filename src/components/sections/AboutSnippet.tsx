...
const institutions = [
  ...
  { label: "HSBC",          logo: "/assets/hsbc.png" },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-px" style={{ background: "#D1D9E6" }}>
              {institutions.map((item) => (
                <div
                  key={item.label}
                  className="bg-white flex items-center justify-center p-8 min-h-[100px]"
                >
